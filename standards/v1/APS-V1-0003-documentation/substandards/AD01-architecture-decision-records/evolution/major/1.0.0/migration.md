---
name: "Migrating to APS-V1-0003.AD01 1.0.0"
description: "How to replace committed CLAUDE.md symlinks with byte-identical copies"
---

# Migrating from APS-V1-0003.AD01 0.1.0 to 1.0.0

AD01 has no migration of its own beyond its parent's. It ships one
template whose `CLAUDE.md` was a symlink and is now a copy; projects
that already scaffolded it keep whatever they have, because the
installer never overwrites. The parent's migration follows.
