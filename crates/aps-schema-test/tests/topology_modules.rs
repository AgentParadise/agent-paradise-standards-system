//! code-topology modules.json ↔ modules.schema.json drift guard.
...
const SCHEMA: &str =
    include_str!("../../../standards/v1/APS-V1-0001-code-topology/schemas/modules.schema.json");
...
fn modules_json_matches_schema() {
    ...
    let raw = fs::read_to_string(project.path().join(".topology/metrics/modules.json")).unwrap();
